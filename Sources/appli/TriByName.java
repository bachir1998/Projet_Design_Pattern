...
public class TriByName implements InterfaceTri {
    ...
    public Collection<People> Tri(File file, String _start, String _stop) {
        ...
        */
        ...
        if (lines != null) {
            ...
            Collections.sort(peopleByDuration, (one_name, other_name)->one_name.getName().compareToIgnoreCase(other_name.getName()));
